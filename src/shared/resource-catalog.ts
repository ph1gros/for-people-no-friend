...
> = {
  ...
  'voice-genie-feibi': {
    ...
    compatibility: 'Genie-TTS（V2ProPlus）',
    language: '中文',
    dependencies: ['genie-tts', 'genie-data', 'genie-language-data'],
    installTier: 'voice-genie-feibi',
    usageRestriction: '上游示例音色；角色及声音相关权利归原权利人，使用须遵守随附说明。',
  },
  'voice-genie-thirtyseven': {
    ...
    language: '英语',
    dependencies: ['genie-tts', 'genie-data', 'genie-language-data'],
    installTier: 'voice-genie-thirtyseven',
    usageRestriction: '上游示例音色；角色及声音相关权利归原权利人，使用须遵守随附说明。',
  },
  'bert-japanese': {
    category: 'base',
...
export const BUNDLED_RESOURCE_CATALOG: ResourceCatalog = {
  ...
  resources: [
    ...
    {
      id: 'genie-language-data',
      name: 'Genie 中英文发音词典',
      summary: '为语音合成提供中英文文本读音，帮助引擎处理分词、读音与词性，不决定角色音色。',
      license: '上游仓库标注 MIT；词典与依赖按各自许可，见随附说明',
      latestVersion: '1.0.0',
    },
    {
      id: 'voice-genie-feibi',
      name: '菲比（Feibi）音色',
      summary: '提供菲比（Feibi）的中文音色，决定角色发声特征；角色出自《鸣潮》。',
      license: '上游仓库标注 MIT；角色及声音权利另行适用，见随附说明',
      latestVersion: '1.0.0',
    },
    {
      id: 'voice-genie-thirtyseven',
      name: '37（ThirtySeven）音色',
      summary: '提供37（ThirtySeven）的英语音色，决定角色发声特征；角色出自《重返未来：1999》。',
      license: '上游仓库标注 MIT；角色及声音权利另行适用，见随附说明',
      latestVersion: '1.0.0',
    },
    {
